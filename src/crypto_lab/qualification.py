...
def qualify_runtime_identity(
    ...
    *,
    ...
    return {
        ...
        "installed_files_verified": current["installed_files_verified"],
        "installed_record_sha256": current["installed_record_sha256"],
        "installed_payload_sha256": current["installed_payload_sha256"],
        "installed_payload_file_count": current["installed_payload_file_count"],
        "installed_record_hashed_file_count": current["installed_record_hashed_file_count"],
        "installed_native_extension_count": current["installed_native_extension_count"],
        "allowed_cache_file_count": current["allowed_cache_file_count"],
