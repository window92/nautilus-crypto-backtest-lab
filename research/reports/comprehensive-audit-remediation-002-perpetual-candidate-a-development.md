...
- Protocol: `801e7c02a62e819c22910fe7dd45713243bc7b0d8f65f63c50bbba8cd5c11161`
- Started trials: `5`
- Selected trial: `comprehensive-audit-remediation-002-perpetual-candidate-a-development`
...
- `comprehensive-audit-remediation-002-spot-benchmark-buy-and-hold-1x-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
- `comprehensive-audit-remediation-002-spot-candidate-a-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
- `comprehensive-audit-remediation-002-spot-candidate-b-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
- `comprehensive-audit-remediation-002-perpetual-benchmark-buy-and-hold-1x-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
- `comprehensive-audit-remediation-002-perpetual-candidate-a-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
...
- Claim reasons: `['PARTITION_LEAKAGE', 'HOLDOUT_INVALID_OR_CONSUMED', 'MONTE_CARLO_NOT_COMPLETED', 'EXPLORATORY_PROTOCOL', 'LATER_PROTOCOL_REANALYSIS', 'SAMPLE_ADEQUACY_NOT_ADEQUATE']`
