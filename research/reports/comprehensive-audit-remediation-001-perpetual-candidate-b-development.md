...
- Started trials: `6`
- Selected trial: `comprehensive-audit-remediation-001-perpetual-candidate-b-development`
...
- `comprehensive-audit-remediation-001-perpetual-candidate-b-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
