...
- Started trials: `2`
- Selected trial: `adversarial-remediation-002-retry-002-spot-benchmark-buy-and-hold-1x-development`
...
- Claim reasons: `['UNDERLYING_OFFICIAL_RUN_INVALID', 'QUALIFICATION_EVIDENCE_NOT_PROFITABILITY_PROOF', 'PARTITION_LEAKAGE', 'HOLDOUT_INVALID_OR_CONSUMED', 'MONTE_CARLO_NOT_COMPLETED', 'EXPLORATORY_PROTOCOL', 'SAMPLE_ADEQUACY_NOT_ADEQUATE']`
