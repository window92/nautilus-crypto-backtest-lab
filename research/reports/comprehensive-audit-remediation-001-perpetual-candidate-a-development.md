...
- Protocol: `a652e234a441f297fae4d1759fd151b268c9ea20d66194ff5aaffe1fa48a3f41`
- Started trials: `5`
- Selected trial: `comprehensive-audit-remediation-001-perpetual-candidate-a-development`
...
- `comprehensive-audit-remediation-001-spot-benchmark-buy-and-hold-1x-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
- `comprehensive-audit-remediation-001-spot-candidate-a-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
- `comprehensive-audit-remediation-001-spot-candidate-b-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
- `comprehensive-audit-remediation-001-perpetual-benchmark-buy-and-hold-1x-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
- `comprehensive-audit-remediation-001-perpetual-candidate-a-development` — `COMPLETED` — OFFICIAL_RUN_COMPLETED
