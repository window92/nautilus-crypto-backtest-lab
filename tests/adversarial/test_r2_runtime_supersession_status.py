    ...
    def test_superseded_candidate_and_benchmark_are_both_ineligible(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            for key in (
                ...
                "retry-015-spot-benchmark:PRIMARY",
                "retry-015-spot-candidate-a:REPLAY",
                "retry-015-spot-candidate-b:PRIMARY",
                "retry-015-perpetual-benchmark:REPLAY",
                "retry-015-perpetual-candidate-a:PRIMARY",
                "retry-015-perpetual-candidate-b:REPLAY",
                "retry-016-spot-benchmark:PRIMARY",
                "retry-016-spot-benchmark:REPLAY",
                "retry-017-spot-benchmark:PRIMARY",
                "retry-017-spot-candidate-a:REPLAY",
                "retry-017-spot-candidate-b:PRIMARY",
